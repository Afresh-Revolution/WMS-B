...
const ROLE_PERMISSION_PRESETS = {
  ...
  hod: ["departments.view", "employees.view", "leave.view_team", "tasks.view", "tasks.assign", "targets.view", "reports.view"],
  employee: ["profile.view", "profile.update", "leave.request", "tasks.view", "targets.view", "meetings.view", "announcements.view"],
  nysc_intern: ["profile.view", "tasks.view", "targets.view", "meetings.view", "announcements.view"],
};
